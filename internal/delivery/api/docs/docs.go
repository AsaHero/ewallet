...
const docTemplate = `{
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/models.AnonBroadcastResponse"
                            }
                        }
                    },
                    "500": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.CreateAnonBroadcastRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.AnonBroadcastFilters"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.ParseImageRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/parser.ParseImageView"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "type": "string",
                        "default": "aggregate",
                        "description": "Mode (aggregate/per_account)",
                        "name": "mode",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/query.BalanceTimeseriesView"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "models.CreateAnonBroadcastRequest": {
            "type": "object",
            "properties": {
                "language": {
                    "type": "string"
        ...
        "query.AccountBalanceSeriesView": {
            "type": "object",
            "properties": {
                "account_id": {
                    "type": "string"
                ...
                "points": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/query.BalanceTimeseriesPointView"
                    }
                },
                "totals": {
                    "$ref": "#/definitions/query.BalanceTimeseriesTotalsView"
                }
            }
        },
        ...
        "query.BalanceTimeseriesPointView": {
            "type": "object",
            "properties": {
                "balance_close": {
                    "type": "number"
        ...
        "query.BalanceTimeseriesTotalsView": {
            "type": "object",
            "properties": {
                "change": {
                    "type": "number"
        ...
        "query.BalanceTimeseriesView": {
            ...
            "properties": {
                ...
                "points": {
                    "description": "for aggregate mode",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/query.BalanceTimeseriesPointView"
                    }
                ...
                "series": {
                    "description": "for per_account mode",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/query.AccountBalanceSeriesView"
                    }
                },
                "to": {
                    "type": "string"
